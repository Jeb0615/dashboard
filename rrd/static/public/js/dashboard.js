...
dashboard.getRam = function () {
    $.get("http://10.10.10.176:1988/page/memory", function (data) {
	alert(data)
        if (data.msg == "success") {
...
dashboard.getDf = function () {
    $.get("http://127.0.0.1:1988/page/df", function (data) {
...
dashboard.getCpu = function () {
    $.get("http://127.0.0.1:1988/page/cpu/usage", function (data) {
        if (data.msg != "success") {
            return
        }
...
dashboard.getDiskstats = function () {
    $.get("http://127.0.0.1:1988/page/diskio", function (data) {
...
dashboard.getOs = function () {
    generate_os_data("http://127.0.0.1:1988/proc/kernel/version", "#os-info");
    generate_os_data("http://127.0.0.1:1988/proc/kernel/hostname", "#os-hostname");
    generate_os_data("http://127.0.0.1:1988/system/date", "#os-time");
    generate_os_data("http://127.0.0.1:1988/page/system/uptime", "#os-uptime");

    $.get("http://127.0.0.1:1988/version", function(d){
        $("#agent-version").text(d);
    });
}

dashboard.getLoadAverage = function () {
    $.get("http://127.0.0.1:1988/page/system/loadavg", function (d) {
        if (d.msg != "success") {
            return
        }
    ...
    generate_os_data("http://127.0.0.1:1988/proc/cpu/num", "#core-number");
}
